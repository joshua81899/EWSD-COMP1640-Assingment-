...
/**
 * TabContent component that handles animations between tab content
 * 
 * @param {Object} props
 * @param {string} props.activeTab - ID of the currently active tab
 * @param {Array} props.tabs - Array of tab objects with id, title, and content properties
...
const TabContent = ({ 
  ...
  return (
    <main ref={tabContentRef} className={`py-6 px-4 sm:px-6 lg:px-8 opacity-100 ${className}`}>
      {currentTabContent ? (
        <>
